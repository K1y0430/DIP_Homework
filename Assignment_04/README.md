...
* `figures/r_0.png`, `r_50.png`, `r_99.png`: representative reprojection verification results for Task 1.
...
* Reprojection verification figures
...
#### 5.1 Reprojection Verification

<img src="figures/r_0.png" alt="Task 1 Reprojection Result 1" width="700">

<img src="figures/r_50.png" alt="Task 1 Reprojection Result 2" width="700">

<img src="figures/r_99.png" alt="Task 1 Reprojection Result 3" width="700">

The reprojection results show that the recovered sparse 3D points can be projected back to the image plane in a visually reasonable way. Across different viewpoints, the projected points are generally aligned with the chair structure, indicating that the recovered camera poses and sparse geometry are consistent with the image observations.

The three examples above correspond to early, middle, and later viewpoints in the image sequence. Together they show that the COLMAP reconstruction is stable across different views. Although the result remains sparse, it is sufficient to provide reliable initialization for the simplified Gaussian representation in Task 2.
...
The reprojection verification results further confirm that the recovered camera parameters and sparse 3D structure are reasonable. Therefore, the COLMAP output serves as an effective starting point for the subsequent Gaussian-based optimization.
